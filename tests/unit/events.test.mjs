...
test("돌봄 상태 우선순위로 이벤트를 정렬한다", () => {
  assert.deepEqual(sortEvents(events).map((event) => event.event_id), ["emergency", "warning", "normal"]);
});
...
test("오늘 발생한 이벤트만 상태별로 집계한다", () => {
  ...
  assert.deepEqual(summary, { total: 2, normal: 1, caution: 0, warning: 0, emergency: 1, unconfirmed: 1 });
});
