...
const events = [
  ...
  { event_id: "fault", care_status: "normal", event_status: "new", event_type: "camera_fault", occurred_at: "2026-08-05T11:00:00+09:00", reason: "카메라 오류" },
];

test("돌봄 상태 우선순위로 이벤트를 정렬한다", () => {
  assert.deepEqual(sortEvents(events).map((event) => event.event_id), ["emergency", "warning", "fault", "normal"]);
});
