...
database_path="$(absolute_from_repo "${WARDY_DATABASE_PATH:-/var/lib/wardy/db/wardy.sqlite}")"
training_data_path="$(absolute_from_repo "${WARDY_TRAINING_DATA_PATH:-/var/lib/wardy/training}")"
